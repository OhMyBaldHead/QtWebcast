...
template <> constexpr inline auto Dialog::qt_create_metaobjectdata<qt_meta_tag_ZN6DialogE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "user_t",
        "user",
        "on_chatroom_itemDoubleClicked",
        "QListWidgetItem*",
        "item",
        "on_destory_clicked",
        "on_exit_btn_clicked",
        "on_roomlist_btn_clicked",
        "onsigRoomList"
    };
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'on_chatroom_itemDoubleClicked'
        QtMocHelpers::SlotData<void(QListWidgetItem *)>(5, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 6, 7 },
        }}),
        // Slot 'on_destory_clicked'
        QtMocHelpers::SlotData<void()>(8, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_exit_btn_clicked'
        QtMocHelpers::SlotData<void()>(9, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_roomlist_btn_clicked'
        QtMocHelpers::SlotData<void()>(10, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onsigRoomList'
        QtMocHelpers::SlotData<void(user_t)>(11, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
    };
...
void Dialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->onsigRoomName((*reinterpret_cast< std::add_pointer_t<user_t>>(_a[1]))); break;
        case 1: _t->on_chatroom_itemDoubleClicked((*reinterpret_cast< std::add_pointer_t<QListWidgetItem*>>(_a[1]))); break;
        case 2: _t->on_destory_clicked(); break;
        case 3: _t->on_exit_btn_clicked(); break;
        case 4: _t->on_roomlist_btn_clicked(); break;
        case 5: _t->onsigRoomList((*reinterpret_cast< std::add_pointer_t<user_t>>(_a[1]))); break;
        default: ;
        }
    }
}
