...
template <> constexpr inline auto MainWindow::qt_create_metaobjectdata<qt_meta_tag_ZN10MainWindowE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'onSigReg'
        QtMocHelpers::SlotData<void(user_t)>(7, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 8, 9 },
        }}),
        // Slot 'onSigLogin'
...
void MainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->onSigReg((*reinterpret_cast< std::add_pointer_t<user_t>>(_a[1]))); break;
        case 4: _t->onSigLogin((*reinterpret_cast< std::add_pointer_t<user_t>>(_a[1]))); break;
        default: ;
        }
    }
